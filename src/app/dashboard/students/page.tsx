              ...
              {students.map((student) => (
                <tr key={student.id} className="border-b border-gray-50 hover:bg-gray-50">
                  ...
                  <td className="p-4 text-center">
                    ...
                    <LinkParentForm studentId={student.id} studentName={student.name} linkedParents={student.parents.map(sp => ({ id: sp.parent.id, name: sp.parent.name, email: sp.parent.email }))} />
                  </td>
                </tr>
              ))}
            </tbody>
